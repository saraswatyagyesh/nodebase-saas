...
// import { authClient } from "@/lib/auth-client"; <-- UNCOMMENT THIS WHEN AUTH CLIENT IS READY
                ...
                <SidebarMenu>
                    ...
                    <SidebarMenuItem>
                        <SidebarMenuButton tooltip="Sign out" className="gap-x-4 h-10 px-4" onClick={ () => {}
                            // () => authClient.signOut({ fetchOptions: { onSuccess: () => { router.push("/login"); }, }}) <-- UNCOMMENT THIS WHEN AUTH CLIENT IS READY
                            } >
